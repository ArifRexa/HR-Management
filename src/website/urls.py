...
from website.views import (
    ...
    BlogDetailAPIView,
    BlogListAPIView,
    BlogListByIDsAPIView,
    BlogViewLogAPIView,
    BlogsWithoutAuthorAPIView,
...
urlpatterns = [
    ...
    path('website/blog-view-logs/', BlogViewLogAPIView.as_view(), name='blog-view-log'),
    path('website/blogs/without-author/', BlogsWithoutAuthorAPIView.as_view(), name='blogs-without-author'),
    path('website/blogs/by-ids/<str:ids>/', BlogListByIDsAPIView.as_view(), name='blog-list-by-ids'),
    path('website/blogs/<slug:slug>/', BlogDetailAPIView.as_view(), name='blog-detail'),
    path('website/blogs/employees/<int:employee_id>/', EmployeeBlogsAPIView.as_view(), name='employee-blogs'),
    ...
    path('website/technologies/<slug:identifier>/', TechnologySlugDetailView.as_view(), name='technology-detail-slug'),
    ...
    path('website/top3percent/', Top3PercentApiView.as_view(), name='top3percent-api'),
