window.onload = function() {
    ...
    const blog_context_field_container = blog_context_group.getElementsByClassName("inline-related")[0]
    const blog_context_description = blog_context_field_container.getElementsByClassName("form-row field-description")[0]
